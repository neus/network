...
- Keep everything vendor-safe and aligned with **`docs/`** and the hosted API behavior.
- Do not reference private workspaces, company-only policy files, or non-public runbooks.
