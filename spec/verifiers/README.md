...
**Internal schemas** (`docs/verifiers/schemas/`) show the full shape including internal fields like `internalSocialToken` and `walletAddress` that the hosted flow populates automatically.
