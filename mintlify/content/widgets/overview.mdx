...
<CardGroup cols={2}>
  <Card title="VerifyGate Component" icon="shield" href="#verifygate">
    Gate UI behind verification requirements.
  </Card>
  <Card title="ProofBadge Component" icon="badge-check" href="#proofbadge">
    Display verification status by proof receipt ID.
  </Card>
  <Card title="Script Tag Embed" icon="code" href="#script-tag-no-framework-required">
