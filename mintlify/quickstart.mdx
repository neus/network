...
2. If NEUS has enabled hosted auth code exchange for your deployment, your server exchanges the returned auth `code` at `POST /api/v1/auth/code/exchange` with the server credential issued during partner onboarding.
