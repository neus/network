...
Verifier metadata is a single source of truth. Frontend apps, SDKs, widgets, MCP, and docs consume the API catalog instead of maintaining parallel metadata.
