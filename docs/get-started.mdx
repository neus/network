...
**Trust network:** one **`proofId`** feeds **gates**, **hub profile**, and **agents**—reuse it instead of one-off signatures. **Billing:** credits and sponsor grants are how metered verification maps to your org wallet; see **[Billing](./platform/billing)**.

**Try code first?** **[Quickstart](./quickstart)** — then complete the steps below before production traffic.
