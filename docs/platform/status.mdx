...
| **OAuth MCP onboarding** | `neus setup` → `neus doctor --live` |
...
| --------- | ---------------- |
| **Mainnet anchoring** | Permanent on-chain proof anchoring for issued proofs (hosted proofs and testnet contracts work today without waiting for this) |
