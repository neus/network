...
Pair x402 with an agent permission receipt to set a spending cap. The receipt identifies the agent, records who approved it, and limits how much it may pay.
