...
One ID. Reusable everywhere. Product flow: **[Integration](../integration)**.
...
// Gate check — same address as the proof signer; prefer saved proofId + proofs/check before prompting verify again
const signerAddress = '0x...'; // from the wallet used in verify()
