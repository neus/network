...
**Default for shipped products:** **your organization pays** verification (org credits + **sponsor grants**). End users run Hosted Verify; they should not need to fund personal credits as a first step. Self-pay and **x402** are advanced paths—linked below—not the default story.
...
**Billed wallet** comes from authentication: **sponsor grant** (preferred for customer flows), **signing wallet**, **x402 receipt**, or some **gate** setups. **Without** a valid sponsor grant, the **signing wallet** may be charged—appropriate for personal or dev use; use sponsors for production customer traffic.
