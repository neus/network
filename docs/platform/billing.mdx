---
title: Billing
description: Credits, visitor checkout, and pay-per-call — who pays for what on NEUS.
icon: credit-card
---

Checks cost credits. Your credits spend first; visitors only pay when you turn on visitor checkout. [Pricing](./pricing) has the per-check amounts and the live estimator.

**Hosted sign-in** never costs credits they apply when a trust check runs, a receipt is saved, or Pro hosted AI is used.
