...
The public trust-check resource supports standards-native x402 v2 payment. See [x402 pay-per-call](./x402) for the payable URL, transport headers, and retry flow.
