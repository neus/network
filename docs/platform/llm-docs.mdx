...
1. [Home](/) — install NEUS or choose an agent, app, or SDK path
2. [MCP overview](../mcp/overview) — connect an assistant
3. [Agent setup](../agents/agent-verification-flow) — set identity and permissions
4. [MCP tools](../mcp/tools) — exact tool behavior
5. [Trust](../verification/overview) — checks and reusable proofs
...
- Profiles, agents, portals, gates, and proofs: [Ecosystem](../platform/overview)
