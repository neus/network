...
**Pro adds:** jobs, the agent workspace, advanced hosted models, more monthly credits, and priority support. Published listings can collect payment after required checks pass. Enterprise adds custom credit packages, rollout support, security review, and flexible billing.
