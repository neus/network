...
A **portal** is how you publish trust checkout from your NEUS profile: choose which checks visitors must pass, set pricing, publish once, and embed with one public `gateId`. Sign-in and checks run on **Hosted Verify** — visitors do not need wallet code in your app.
