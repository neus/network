...
When to retry: read endpoints can be retried; verification creation only when you can prove the original request did not succeed. Polling should back off on `429` or transport issues.
