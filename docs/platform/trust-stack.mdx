...
NEUS is one hosted surface for **sign-in**, **checks**, **gates**, and **agents** — sharing the same browser, the same receipts, and the same profile. You do not stitch separate auth and verification products.
