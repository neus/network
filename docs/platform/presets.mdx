...
Use `?verifiers=<id>` (or `?preset=<id>` for the same result with a single check). Prefer account and hosted checks for most products:
...
<CardGroup cols={2}>
 ...
 <Card title="Sell access" icon="building" href="./setup">
  Set checks and price once, embed one link.
 </Card>
</CardGroup>
