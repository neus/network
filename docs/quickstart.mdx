...
<Info>
  This is the selling-access recipe. Connecting an assistant? [Add the hosted MCP endpoint](./mcp/setup). Adding sign-in to an app? [Use hosted sign-in](./cookbook/auth-hosted-verify).
</Info>
