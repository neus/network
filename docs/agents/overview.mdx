...
description: Verified identity, limited permissions, and reusable receipts for agents.
icon: robot
"og:image": "/images/og-agents.png"
"twitter:image": "/images/og-agents.png"
---

NEUS gives agents a portable identity plus explicit permissions that work across tools, editors, and apps. Integrations can check those receipts before granting access or allowing an action.
...
## Two receipts make an agent trusted
