...
One-time user approval lets your backend create proofs without asking for a signature on every request. This is different from creating a **listing** in your profile for hosted checks. See [Integrations](../cookbook/integrations).
