...
The same `qHash` works in a React widget, a server gate, an MCP assistant, or a partner app — because the receipt is the trust context, not a local state flag.
