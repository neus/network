...
- Create competing NEUS Network services (subject to the terms of this agreement and applicable licenses)
...
- SDKs, developer tools, reference smart contracts, and examples are licensed under Apache 2.0
- The CAIP-380 specification is released under CC0 1.0
