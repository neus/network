...
These Terms of Use ("Terms") govern your use of the NEUS Network protocol, API services, documentation, and related tools (collectively, the "Service") provided by NEUS Network, Inc., a Delaware corporation ("NEUS," "we," "us," or "our").
...
NEUS Network provides decentralized verification infrastructure that enables creation of cryptographic proofs for digital assets, content ownership, and credentials. The Service includes:

- Developer tools and integration examples
- Software development kits (SDKs) and documentation
- API services for verification requests
- Protocol infrastructure and smart contracts
...
- Integrate NEUS protocols into applications and services
...
- Create competing NEUS Network services (subject to Business Source License restrictions)
...
- Users control their verification data through wallet-based authentication
- All data handling is governed by our [Privacy Policy](./privacy-policy.md)
...
- SDKs and developer tools are licensed under Apache 2.0
- Smart contracts are licensed under Business Source License 1.1
...
Exceptional Circumstances: In exceptional circumstances (e.g., service outages preventing credit usage, duplicate charges due to technical errors), refunds may be considered on a case-by-case basis. Contact `mailto:info@neus.network` with your transaction details.
