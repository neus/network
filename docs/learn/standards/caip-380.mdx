...
CAIP-380 is at Draft status in the official CASA registry. Advancing to Review and Accepted requires at least two independent implementations and editor advancement. See the [whitepaper standards section](/whitepaper#standards-and-interoperability) for lifecycle status.
