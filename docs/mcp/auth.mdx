...
For servers, CI, and other environments that cannot open a browser, use a durable personal access key instead.
...
| **Access key (`npk_*`)** | Servers, CI, automation, or operator machines with stable environment variables. Durable and never expires |
