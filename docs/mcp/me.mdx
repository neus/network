...
Most sessions do **not** need a separate `neus_me` call. Start with **`neus_context`**; when the connection is authenticated, it already includes signed-in profile context.
