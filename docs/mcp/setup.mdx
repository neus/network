...
**Cursor:** if you already installed the **neus-trust** plugin, skip Cursor in setup (`neus setup --client vscode,claude,codex`) and leave `~/.cursor/mcp.json` empty so you do not get a duplicate NEUS MCP. Public tools = **13** (correct).
