...
Installs the trust skill, detects your editors, and signs you in with OAuth. Marketplace plugins are an optional shortcut — they never register another MCP server.
