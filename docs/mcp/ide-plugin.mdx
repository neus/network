...
Signed in on [neus.network](https://neus.network/profile?tab=account)? Use **Mount in** for Cursor, Claude Code, or Codex — then run the copied `neus mount` command in your project repo.
