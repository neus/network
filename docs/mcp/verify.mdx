...
A **Trust Result** in plain language (Passed / Action needed / Blocked). On success, the tool also returns the receipt ID (`qHash`) for your server. If a hosted step is required, you get a `next_action` link instead of raw JSON dumps in user-facing replies.
