...
| Interactive | **`neus_verify_or_guide`** when a step needs a browser (OAuth, personhood, payment, wallet connect). Returns a hosted link. |
...
<CardGroup cols={2}>
  ...
  <Card title="Verify or guide" icon="signs-post" href="./verify-or-guide">
    Reuse a proof or return the next hosted step.
  </Card>
