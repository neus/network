...
`VerifyGate`: check to hosted verify when needed to unlock. Create defaults **private**, matching raw `client.verify()`. [Security and trust](../platform/security-and-trust) | [Get started](../get-started)
