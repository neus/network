...
description: Drop-in checkout for a published NEUS gate.
icon: object-group
---
...
1. In [NEUS Hub](https://neus.network/profile?tab=listings), create a gate and choose the checks visitors must pass.
