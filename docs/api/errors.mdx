...
Handle API errors with the same basic pattern: `code`, `message`, and `type`. The main goal is to know whether to fix the request, retry later, or send the user into a hosted flow.
