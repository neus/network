...
Handle API errors with consistent structure: `code`, `message`, `type`. Retry on `429`; do not retry verification creation unless you can prove the original request failed.
