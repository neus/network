...
title: API
sidebarTitle: API
description: Call NEUS from your backend with the same results as the SDK while keeping credentials out of browsers.
icon: terminal
"og:image": "/images/og-api.png"
"twitter:image": "/images/og-api.png"
---

Call NEUS from servers, workers, and CLIs. Publish a listing, pass its `gateId`, and NEUS resolves policy and billing. Proof IDs match the SDK (`qHash` in responses).
