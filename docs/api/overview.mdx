...
| `/api/v1/gates/{gateId}` | GET | Public gate snapshot (requirements, price, schedule) |
| `/api/v1/gates/{gateId}/fulfill` | POST | Deliver gate reward after verify (+ payment) — see [Hosted Gate Checkout](../platform/hosted-gate-checkout) |
