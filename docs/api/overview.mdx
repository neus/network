...
title: API
sidebarTitle: API
description: HTTP from your backend. Same results as the SDK. Not for browsers.
icon: terminal
"og:image": "/images/og-api.png"
"twitter:image": "/images/og-api.png"
---

Call NEUS from servers, workers, and CLIs. Publish a gate, pass its `gateId`, and NEUS resolves policy and billing. Receipt IDs match the SDK (`qHash` in responses).
...
<CardGroup cols={2}>
 <Card title="Choose a path" icon="book" href="../get-started">
   App, assistant, agent, or API — pick one.
 </Card>
