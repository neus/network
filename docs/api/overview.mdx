...
Call NEUS from servers, workers, and CLIs. Publish a portal, pass its `gateId`, and NEUS resolves policy and billing. Proof IDs match the SDK (`qHash` in responses).
