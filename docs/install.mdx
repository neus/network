...
This gives your assistant one public trust loop: check existing trust receipts, guide any missing verification step, then summarize the outcome as **NEUS Verify**.
