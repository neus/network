...
description: NEUS Portable Trust Infrastructure for humans and AI. Architecture and trust model, version 1.0, August 2026.
icon: book-open
...
**Canonical version:** docs.neus.network/whitepaper
...
<Frame caption="**Figure 2.** Public interfaces feed one verification engine. Gates evaluate current proof state at the protected boundary.">
  <img src="/images/whitepaper/figure-2-system-architecture.svg" alt="NEUS system architecture: integration surfaces feed the verification engine, which produces saved results that gates evaluate before protected actions." />
</Frame>
...
<Frame caption="**Figure 5.** `qHash` can correlate a CAIP-380 signed request with a NEUS proof, but request integrity and verifier outcome remain separate claims.">
  <img src="/images/whitepaper/figure-5-envelope-and-receipt.svg" alt="CAIP-380 request envelope and NEUS trust receipt: the signed envelope proves request integrity, the NEUS receipt records the verifier outcome and lifecycle state, qHash correlates them but does not prove the result by itself." />
</Frame>
...
Smart contracts were audited by SafeStack AI in March 2026. The audit completed with no critical, high, medium, or low severity findings. See the [Trust Center](/platform/security-and-trust#smart-contract-audit) for details.
