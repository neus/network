...
- **`docs/verifiers/schemas/`** — Full internal shape: includes fields like `internalSocialToken` that the hosted OAuth flow populates automatically. Do not supply these fields in API calls.
