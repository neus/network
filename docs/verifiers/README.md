...
JSON Schemas in **`schemas/`** describe the `data` object for each public verifier. They are generated from the live verifier catalog so they stay aligned with validation.
