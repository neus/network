...
| Term | Meaning |
|------|---------|
| **Proof receipt ID** | Stable identifier for a proof, exposed as `proofId` in SDK responses (same value as `qHash` on the wire). See **[Proof receipts](../platform/receipts-and-results)**. |
