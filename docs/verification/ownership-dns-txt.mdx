...
description: Prove domain control by publishing a DNS TXT record tied to the verifying account.
icon: globe
---
...
| Field | In JSON Schema | What integrators should know |
|------|------------------|------------------------------|
...
See also: [Domain verification cookbook](../cookbook/domain-verification), [Verifier reference](../verifiers/ownership-dns-txt).
