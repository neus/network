...
Prove a person belongs to a Google Workspace or Microsoft 365 organization, then gate org-only apps, agents, and content. OAuth runs on NEUS — use Hosted Verify or `VerifyGate`, never a custom OAuth UI.
