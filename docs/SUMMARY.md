...
* [ownership-basic](verifiers/ownership-basic.md)
* [ownership-social](verifiers/ownership-social.md)
* [ownership-pseudonym](verifiers/ownership-pseudonym.md)
* [ownership-dns-txt](verifiers/ownership-dns-txt.md)
* [ownership-org-oauth](verifiers/ownership-org-oauth.md)
* [contract-ownership](verifiers/contract-ownership.md)
* [nft-ownership](verifiers/nft-ownership.md)
* [token-holding](verifiers/token-holding.md)
* [proof-of-human](verifiers/proof-of-human.md)
* [agent-identity](verifiers/agent-identity.md)
* [agent-delegation](verifiers/agent-delegation.md)
* [wallet-link](verifiers/wallet-link.md)
* [wallet-risk](verifiers/wallet-risk.md)
* [ai-content-moderation](verifiers/ai-content-moderation.md)
...
* [Legal Overview](learn/legal/README.md)
* [Terms of Use](learn/legal/terms-of-use.md)
...
* [Privacy for Integrators](PRIVACY.md)
