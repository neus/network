...
<Note>
  **After** hub signup, **`appId`**, and your first **[Integration](../integration)** loop—use this for **DNS**, **org** flows, and **sponsor** detail. New to NEUS? **[Get started](../get-started)** first.
</Note>
