...
description: Production setup for websites, communities, apps, teams, and partners using hosted verify, linked identity, and proof receipt reuse.
icon: building
---
...
| 3 | Sign with your wallet to finish linking |
