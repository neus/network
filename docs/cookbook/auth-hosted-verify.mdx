---
title: Hosted Verify
description: Hosted sign-in and trust checks on NEUS — one browser surface for your app.
icon: key
---

**Hosted Verify** is `https://neus.network/verify`. Use it when a step needs a **browser ceremony** — sign-in, passkey, wallet, OAuth, human check, social proof, or gate checkout. Your app does **not** embed wallet or passkey UI.
