...
**MCP:** tools return **`neus.network/verify`** links without requiring a key; add **Bearer** (personal API key from **[Access keys](https://neus.network/profile?tab=account)**) when you need a signed-in MCP session. [MCP Auth](../mcp/auth)
