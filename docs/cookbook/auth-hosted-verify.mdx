---
title: Hosted sign-in and checks
description: Use NEUS for passkey, OAuth, and gate checkout without building sign-in UI in your app.
icon: key
---
...
|--|----------------|---------------------------------------------------------------------|
| Purpose | NEUS **session** (Hub, profile, later checks) | **Proof** / gate outcome |
