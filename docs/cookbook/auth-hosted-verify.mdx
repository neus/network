---
title: Hosted Verify
description: Hosted verification flow for login, social checks, human checks, org checks, and gated access.
icon: key
---
...
After redirect or popup completion, read the result with the SDK, store the qHash, and reuse that proof before asking the user to verify again.
