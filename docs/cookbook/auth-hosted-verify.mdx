...
| `appId` | Your app ID from Hub |
| `billingWallet` | Wallet that pays for checks (your Hub account) |
...
Server-created receipts and access keys: [Server integrations (advanced)](../cookbook/server-advanced).
