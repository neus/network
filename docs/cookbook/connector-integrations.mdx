...
description: Link Google, GitHub, Slack, Notion, and 1,200+ apps to your NEUS assistant.
icon: plug
---
...
| --- | --- |
| Google | Sign in once. Gmail, Drive, and Calendar connect through Composio when you need them |
| GitHub | Read repos, create issues, review pull requests |
| Slack | Search channels and send messages |
| Notion | Search and edit workspace pages |
| Jira | Create and track issues and comments |
| Browse all apps | 1,200+ more. Your assistant finds the right tool when you ask |
...
- For native OAuth apps (Google, GitHub), tokens are encrypted and sealed in private storage, never exposed to the browser or assistant.
