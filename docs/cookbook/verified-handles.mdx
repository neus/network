...
description: Bind a pseudonymous handle to a wallet, display a verified badge, and gate creator actions with NEUS Proofs.
icon: badge-check
---

Use NEUS to make creator handles portable and verifiable. A user claims a handle, NEUS binds it to their wallet with the `ownership-pseudonym` verifier, and your app gets a reusable proof ID it can badge, link, and gate.
