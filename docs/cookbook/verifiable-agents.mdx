...
To bill hosted checks through your product, complete [Quickstart](../quickstart) (create a **portal** under profile → **Portals**). For backend proof creation after user approval, see [Integrations](./integrations). Agent concepts: [Agent concepts](../agents/concepts)
