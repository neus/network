...
To bill hosted checks through your product, complete [Quickstart](../quickstart) (create a **listing** under profile → **Listings**). For backend proof creation after user approval, see [Integrations](./integrations). Agent concepts: [Agent concepts](../agents/concepts)
