...
New here? [Run setup](/) or open the [Quickstart](../quickstart).
...
<CardGroup cols={2}>
 ...
 <Card title="Private cloud agents" icon="shield-check" href="./private-cloud-agents">
 ...
 <Card title="Sell access" icon="building" href="../platform/setup">
...
<CardGroup cols={2}>
 ...
 Credits, Pro, and what verifiers cost.
 </Card>
