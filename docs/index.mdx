...
**Building a product?** **[Get started](./get-started)** — platform profile, link app, credits, `appId`, sponsor grants, then **[choose an integration path](./choose-an-integration-path)**.

**Choosing an integration path?** **[Choose an integration path](./choose-an-integration-path)** — Hosted Verify, Widgets, SDK, API, or MCP.
