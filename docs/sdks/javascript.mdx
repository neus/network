...
| Layer | Use |
|-------|-----|
| Browser | **`getHostedCheckoutUrl`**, **`VerifyGate`**, polling. Default hosted sign-in on **NEUS** ([Hosted sign-in](../cookbook/auth-hosted-verify)) |
...
| `publishToHub: true` | Make the proof discoverable on your profile |
